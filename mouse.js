export class Mouse {
    constructor()  {
        ...
        document.body.addEventListener("mousemove", (e) => {
            ...
            // The following two lines are WIP (not used anywhere yet)
            this.velocity.xv = (this.velocity.x + Math.abs(this.difference.x)) / 2;
            this.velocity.yv = (this.velocity.y + Math.abs(this.difference.y)) / 2;
